...
typedef struct MD5Context
{
	...
	unsigned long count[2];		// number of bits, modulo 2^64 (lsb 1st)
...
static void MD5Update(MD5_CTX *context, const void *in, unsigned long inputLen)
{
	...
	if (inputLen != i)	// 2009:330 LPR: suppress CG errors
